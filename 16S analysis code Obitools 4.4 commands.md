...
FastQC (Andrews S., 2010) purpose is to offer an useful tool for performing basic quality checks on raw sequencing data generated by high-throughput sequencing workflows. It includes a set of modular analyses designed to quickly highlight any potential issues in the data that should be addressed before proceeding with downstream analysis.
